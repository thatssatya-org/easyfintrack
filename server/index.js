...
const GITHUB_CLIENT_ID = process.env.EF_GITHUB_CLIENT_ID || '';
const GITHUB_CLIENT_SECRET = process.env.EF_GITHUB_CLIENT_SECRET || '';
...
async function handleAuthCallback(req, res) {
    ...
    if (!GITHUB_CLIENT_ID || !GITHUB_CLIENT_SECRET) {
        return sendJson(res, 500, { error: 'server_misconfigured', detail: 'VITE_GITHUB_CLIENT_ID/VITE_GITHUB_CLIENT_SECRET not set' });
    }
